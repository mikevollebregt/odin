...
class OSMSubwayInfrastructureNotifier extends StateNotifier<NotifierState> {
  final OSMApi _osmApi;

  OSMSubwayInfrastructureNotifier(this._osmApi) : super(const Initial()) {
    getDetails();
  }
  ...
  getDetails() async {
    ...
    final response = await _osmApi.getSubwayInfastructure();
