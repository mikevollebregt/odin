...
class OSMBusLineInfrastructureNotifier extends StateNotifier<NotifierState> {
  final OSMApi _osmApi;

  OSMBusLineInfrastructureNotifier(this._osmApi) : super(const Initial()) {
    getDetails();
  }
  ...
  getDetails() async {
    ...
    final response = await _osmApi.getBusInfastructure();
