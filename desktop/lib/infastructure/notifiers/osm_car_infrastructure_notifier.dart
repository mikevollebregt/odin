...
class OSMCarInfrastructureNotifier extends StateNotifier<NotifierState> {
  final OSMApi _osmApi;

  OSMCarInfrastructureNotifier(this._osmApi) : super(const Initial()) {
    getDetails();
  }
  ...
  getDetails() async {
    ...
    final response = await _osmApi.getCarInfastructure();
